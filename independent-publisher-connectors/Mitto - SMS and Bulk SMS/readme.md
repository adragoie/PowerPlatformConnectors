...
Mitto’s SMS and Bulk SMS connector allows you to send individual or bulk SMS messages securely and efficiently. It supports message customization, delivery tracking, and usage reporting by country—making it ideal for marketing, alerts, and transactional messaging.

## Publisher: Alessandro Drago, Impresoft Engage

## Prerequisites
You must have an active Mitto account. To get started, visit [Mitto](https://www.mitto.ch/) and request API access. Some features, such as conversion tracking, may require activation by your account manager.
...
### Track Conversions
Track whether a message was delivered using its `messageId`. This feature must be enabled by your account manager.
